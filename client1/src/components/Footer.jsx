      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <div>
              <h3 className="text-lg font-bold">SOCIAL POSTS SHARERS</h3>
              <p className="text-gray-400 text-xs">Empower.Share.Earn</p>
            </div>
          </div>
          ...
          <div className="text-gray-400 text-sm text-center md:text-right">
            <p>© {currentYear} Social Posts Sharers. All rights reserved.</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-4 pt-4 text-center">
          <p className="text-gray-400 text-xs">
            Building the future of social media engagement • Made with ❤️ for creators
          </p>
        </div>
      </div>
    </footer>
